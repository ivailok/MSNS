...
public class ImageHandler {
	...
	public Bitmap getCorrectlyOrientedImage(Context context, Uri photoUri) throws IOException {
	    ...
	    if (rotatedWidth > maxImageWidth || rotatedHeight > maxImageHeight) {
	        float widthRatio = ((float) rotatedWidth) / ((float) maxImageWidth);
	        float heightRatio = ((float) rotatedHeight) / ((float) maxImageHeight);
