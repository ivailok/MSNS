...
import com.msns.R;
import com.msns.fragments.OtherInterestsFragment;
import com.msns.fragments.OtherProfileFragment;
import com.msns.fragments.OtherSparksFragment;
...
public class OtherProfileActivity extends AbstractNavDrawerActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		mViewPager = (ViewPager) findViewById(R.id.other_pager);
        ...
        if ( savedInstanceState == null ) {
            ...
            String getOtherProfileUrl = baseUrl + "users/getprofile?nickname=" + getIntent().getStringExtra("OTHER_PROFILE_NICKNAME");
            ...
            mClient.get(this, getOtherProfileUrl, headers, null, new AsyncHttpResponseHandler() {
            	@Override
            	public void onFailure(int statusCode, Throwable error, String content) {
            		Toast.makeText(OtherProfileActivity.this, "No connection", Toast.LENGTH_SHORT).show();
            	};
            	
                public void onSuccess(String response) {
                    mProfileData = new Gson().fromJson(response, ProfileModel.class);
                    List<Fragment> fragments = getmFragments();
                    ((OtherProfileFragment)fragments.get(0)).setData(mProfileData, false);
                }
            });
            
            String getOtherInterestsUrl = baseUrl + "users/getotherinterests?nickname=" + getIntent().getStringExtra("OTHER_PROFILE_NICKNAME");
            mClient.get(this, getOtherInterestsUrl, headers, null, new AsyncHttpResponseHandler() {
            	@Override
            	public void onFailure(int statusCode, Throwable error, String content) {
            		Toast.makeText(OtherProfileActivity.this, "No connection", Toast.LENGTH_SHORT).show();
            	};
                ...
                public void onSuccess(String response) {
                	...
                	List<Fragment> fragments = getmFragments();
                    ((OtherInterestsFragment)fragments.get(1)).setData(mInterests, false);
                }
            });
        }
        else
        {
        	...
        	List<Fragment> fragments = getmFragments();
            ((OtherProfileFragment)fragments.get(0)).setData(mProfileData, true);
            ...
            ((OtherInterestsFragment)fragments.get(1)).setData(mInterests, true);
        }
    }
    ...
    protected NavDrawerActivityConfiguration getNavDrawerConfiguration() {
        ...
        navDrawerActivityConfiguration.setMainLayout(R.layout.activity_other_profile);
		...
		public Fragment getItem(int position) {
			...
			switch (position)
			{
				case 0:
					...
					break;
				case 1:
					fragment = new OtherInterestsFragment();
					break;
				case 2:
					fragment = new OtherSparksFragment();
					break;
			}
			return fragment;
		}
