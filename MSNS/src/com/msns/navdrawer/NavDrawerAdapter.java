...
public class NavDrawerAdapter extends ArrayAdapter<NavDrawerItem> {
    ...
    public View getItemView( View convertView, ViewGroup parentView, NavDrawerItem navDrawerItem, int position) {
    ...
    public View getSectionView(View convertView, ViewGroup parentView,
        ...
        if (convertView == null) {
            convertView = inflater.inflate( R.layout.nav_drawer_section, parentView, false);
            TextView labelView = (TextView) convertView
